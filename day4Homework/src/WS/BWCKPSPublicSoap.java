...
public class BWCKPSPublicSoap
{
    ...
    public BWCKPSPublicSoap(){}

    public BWCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BWCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BWCExtendedSoapSerializationEnvelope envelope= new BWCExtendedSoapSerializationEnvelope(BWCExtendedSoapSerializationEnvelope.VER11);
