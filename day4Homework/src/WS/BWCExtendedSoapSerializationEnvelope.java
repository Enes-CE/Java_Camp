...
public class BWCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BWCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BWCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BWCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BWCDateTimeConverter dateTimeConverter = new BWCStandardDateTimeConverter();

    public BWCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BWCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BWCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BWCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BWCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BWCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
